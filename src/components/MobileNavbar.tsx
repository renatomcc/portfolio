...
import '../styles/MobileNavbar.sass'

export const MobileNavbar = () => {

    const [navBG, setNavBG] = useState('up')
    const [menuIcon, setMenuIcon] = useState(false)
    let lastScroll = window.pageYOffset

    window.addEventListener('scroll', () => {
        if (window.pageYOffset < 100 && innerWidth < 800) {
            setNavBG('top')
        } else if (window.pageYOffset > lastScroll && window.pageYOffset > 150) {
            setNavBG('down')
        } else setNavBG('up')
    ...
    return (
        <div className={navBG == 'up' ? 'MobileNavbar scroll-up' : navBG == 'top' ? 'MobileNavbar standard' : 'MobileNavbar scroll-down'}>
            <div className="MobilePageLogo">
                <a href="#">
            ...
            <div className="MobileNavMenu">
                ...
                <div className={menuIcon == true ? 'MobileNavLinks showMenu' : 'MobileNavLinks hideMenu'}>
                    <ul onClick={() => {
